		...
		<div class="window">
			...
			<div class="inputs">
				<?php 
					if($_POST['reg'] == 'Зарегистрироваться')
					{
						...
						if($pass1 == $pass2){
							...
							echo "Регистрация прошла успешно, <a href='auto.php'>Авторизуйтесь</a>";
						}
						else
						{
				...
				<form action="reg.php" method="post">
					...
					<input class="inp" name="mail" placeholder="Почта">
				...
				<br><label>Уже есть аккаунт? <a href = 'auto.php'>Авторизуйтесь!</a></label>
				<?php } ?>
			</div>
